...
------ 레시피 3번 닭갈비볶음밥(레시피명, 재료용량, 재료번호, 레시피번호)
INSERT INTO SEMI_RECIPE_INGREDIENT
VALUES (SEQ_SEMI_RECIPE_INGREDIENT.NEXTVAL, 1, 2, 3);

INSERT INTO SEMI_RECIPE_INGREDIENT
VALUES (SEQ_SEMI_RECIPE_INGREDIENT.NEXTVAL, 1, 3, 3);

INSERT INTO SEMI_RECIPE_INGREDIENT
VALUES (SEQ_SEMI_RECIPE_INGREDIENT.NEXTVAL, 1.5, 4, 3);

INSERT INTO SEMI_RECIPE_INGREDIENT
VALUES (SEQ_SEMI_RECIPE_INGREDIENT.NEXTVAL, 1, 7, 3);

INSERT INTO SEMI_RECIPE_INGREDIENT
VALUES (SEQ_SEMI_RECIPE_INGREDIENT.NEXTVAL, 3, 8, 3);

INSERT INTO SEMI_RECIPE_INGREDIENT
VALUES (SEQ_SEMI_RECIPE_INGREDIENT.NEXTVAL, 3.5, 9, 3);
...
SELECT * FROM SEMI_COMMENT_RECIPE;
-- 1) 컬럼명 변경 (DEPT_TITLE -> DEPT_NAME)
ALTER TABLE "SEMI_COMMENT_RECIPE" RENAME COLUMN PARENT_COMMENT_NO TO PARENT_COMMENT_NO_RECIPE;
COMMIT;


---- 4번 게시판(자취요리 레시피 공유) 에 샘플 데이터 생성
SELECT * FROM SEMI_BOARD;
-- ALTER TABLE SEMI_BOARD DROP CONSTRAINT 제약조건명;
-- BOARD_NO, BOARD_TITLE, BOARD_CONTENT, BOARD_WRITE_DATE, BOARD_UPDATE_DATE, BOARD_READ_COUNT, BOARD_DEL_FL, MEMBER_NO, BOARD_CODE
INSERT INTO SEMI_BOARD
VALUES(SEQ_SEMI_BOARD.NEXTVAL, '간단 계란말이 만들기', '계란 조금, 소금, 파 조금', DEFAULT, NULL, DEFAULT, DEFAULT, 1, 4);

INSERT INTO SEMI_BOARD
VALUES(SEQ_SEMI_BOARD.NEXTVAL, '라면죽 만들기', '계란 조금, 라면, 소금, 파 조금, 미원', DEFAULT, NULL, DEFAULT, DEFAULT, 3, 4);

INSERT INTO SEMI_BOARD
VALUES(SEQ_SEMI_BOARD.NEXTVAL, '간장계란밥~', '계란 남은거, 밥 차가운거, 소금, 간장, 당근', DEFAULT, NULL, DEFAULT, DEFAULT, 3, 4);

INSERT INTO SEMI_BOARD
VALUES(SEQ_SEMI_BOARD.NEXTVAL, '봉골레', '국수 남은거, 크림소스, 소금, 설탕, 버섯 조금', DEFAULT, NULL, DEFAULT, DEFAULT, 2, 4);

COMMIT;


---- admin 계정 추가, 비밀번호 admin123
SELECT * FROM SEMI_MEMBER;

INSERT INTO SEMI_MEMBER
VALUES(SEQ_SEMI_MEMBER.NEXTVAL, 'admin', 'admin123', '관리자', '관리자', '01012345678', NULL, NULL, DEFAULT, DEFAULT, 2);

COMMIT;

UPDATE "SEMI_MEMBER"
SET MEMBER_PW = '$2a$10$HfeAoAm1DQ/s1bwRp6fnheBQIjY82YJAyaHquNvtju6z.jwTKyyL6'
WHERE MEMBER_NO = 7;

--SELECT BOARD_CODE "boardCode", BOARD_NAME "boardName"
--FROM "SEMI_BOARD_TYPE"
--ORDER BY BOARD_CODE;

-- 필요한거 (자취요리 레시피 공유) 게시글 제목, 작성자, 작성일/     좋아요 수 (얘는 다른 SELECT문 이용)
SELECT BOARD_TITLE, MEMBER_NICKNAME, BOARD_READ_COUNT,
	TO_CHAR(BOARD_WRITE_DATE, 'YYYY-MM-DD') "BOARD_WRITE_DATE"
FROM "SEMI_BOARD" sb
JOIN "SEMI_MEMBER" sm ON(sb.MEMBER_NO = sm.MEMBER_NO)
WHERE BOARD_CODE = 4;

------- 자취요리 게시판 
INSERT INTO SEMI_BOARD
VALUES(SEQ_SEMI_BOARD.NEXTVAL, '스파게티 만들기', '면, 케찹, 계란 조금, 소금, 파 조금, 저녁에 먹기 좋음', DEFAULT, NULL, DEFAULT, DEFAULT, 4, 4);

INSERT INTO SEMI_BOARD
VALUES(SEQ_SEMI_BOARD.NEXTVAL, '사과잼 토스트', '빵, 사과잼, 계란, 소금, 파 조금, 아침에 먹기 좋음', DEFAULT, NULL, DEFAULT, DEFAULT, 9, 4);

INSERT INTO SEMI_BOARD
VALUES(SEQ_SEMI_BOARD.NEXTVAL, '메추리알 장조림', '메추리알, 간장, 설탕, 소고기 조금, 파 조금, 저녁에 먹기 좋음', DEFAULT, NULL, DEFAULT, DEFAULT, 3, 4);

INSERT INTO SEMI_BOARD
VALUES(SEQ_SEMI_BOARD.NEXTVAL, '알리오올리오 만들기', '면, 케찹, 계란 조금,', DEFAULT, NULL, DEFAULT, DEFAULT, 10, 4);

INSERT INTO SEMI_BOARD
VALUES(SEQ_SEMI_BOARD.NEXTVAL, '된장찌개 만들기', '된장찌개 주요 내용', DEFAULT, NULL, DEFAULT, DEFAULT, 10, 4);

INSERT INTO SEMI_BOARD
VALUES(SEQ_SEMI_BOARD.NEXTVAL, '치킨없는 치킨마요', '치킨마요 주요 내용', DEFAULT, NULL, DEFAULT, DEFAULT, 11, 4);

INSERT INTO SEMI_BOARD
VALUES(SEQ_SEMI_BOARD.NEXTVAL, '스팸동', '스팸, 공기밥, 설탕, 케찹', DEFAULT, NULL, DEFAULT, DEFAULT, 2, 4);

INSERT INTO SEMI_BOARD
VALUES(SEQ_SEMI_BOARD.NEXTVAL, '크래미롤', '크래미롤 주요 내용', DEFAULT, NULL, DEFAULT, DEFAULT, 1, 4);
...
-------- 자취요리 공유 레시피 게시판 조회 확인용
SELECT BOARD_NO,
	BOARD_TITLE,
	MEMBER_NICKNAME,
	BOARD_READ_COUNT,
	(SELECT COUNT(*) FROM "SEMI_BOARD_LIKE" sbl WHERE sb.BOARD_NO = sbl.BOARD_NO) "LIKE_COUNT",
	TO_CHAR(BOARD_WRITE_DATE, 'YYYY-MM-DD') "BOARD_WRITE_DATE"
FROM "SEMI_BOARD" sb 
JOIN "SEMI_MEMBER" sm ON(sb.MEMBER_NO = sm.MEMBER_NO)
