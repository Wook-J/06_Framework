...
VALUES( SEQ_COMMENT_NO.NEXTVAL, '부모 댓글 3',
			  DEFAULT, DEFAULT,	2000, 4, NULL);		-- COMMENT_NO = 2003			1레벨
...
VALUES( SEQ_COMMENT_NO.NEXTVAL, '부모 2의 자식 1',
			  DEFAULT, DEFAULT,	2000, 5, 2002);		-- PARRENT_COMMENT_NO = 2002	2레벨
			 
-- 부모 댓글 2의 자식 1의 자식 댓글			 
INSERT INTO "COMMENT"	
VALUES( SEQ_COMMENT_NO.NEXTVAL, '부모 2의 자식 1의 자식!!!',
			  DEFAULT, DEFAULT,	2000, 1, 2006);		-- PARRENT_COMMENT_NO = 2006	3레벨
